...
public class RedisConfig {
    ...
    public RedisTemplate<String, String>  defaultRedisTemplate(
        ...
        return defaultRedisTemplate(redisTemplate, lettuceConnectionFactory, objectMapper);
    }
...
//        GenericJackson2JsonRedisSerializer gs = new GenericJackson2JsonRedisSerializer(objectMapper);
